...
const year = (inventory[32].car_year);
const make = (inventory[32].car_make);
const model = (inventory[32].car_model);
...
console.log(`The last car make is ${inventory[lastCar].car_make} and the model is ${inventory[lastCar].car_model}`);
